...
fun ShowDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(text = stringResource(id = R.string.city_dialog_title), fontSize = 15.sp)
        },
        //显示有关对话框目的的详细信息的文本。提供的文本样式默认为 Typography.body1
        text = {
            Text(
                text =
                stringResource(id = R.string.city_dialog_content, cityName), fontSize = 14.sp
            )
        },
        ...
        dismissButton = {
            TextButton(
                ...
                Text(
                    stringResource(id = R.string.city_dialog_cancel),
                    fontSize = 15.sp,
                    color = MaterialTheme.colors.secondary
                )
            }
